...
function registerSW() {
  ...
  navigator.serviceWorker.register('./sw.js').then(function (reg) {
    ...
    console.log('Registration succeeded, scop is: ' + reg.scope);
  }).catch(function (err) {
    console.log(err);
  });
}
...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1Ijoia2hhbGVkc2FyaGFuIiwiYSI6ImNqam55anU4cjBhMTYzcm51NXZvdGY0NXUifQ.G5K1v8Z3M_aGyzpA-HByCw',
    maxZoom: 18,
  ...
  document.getElementsByClassName("leaflet-control-attribution")[0].firstChild.tabIndex = -1;
}
/* window.initMap = () => {
  let loc = {
    lat: 40.722216,
...
createRestaurantHTML = (restaurant) => {
  ...
  neighborhood.setAttribute('aria-label', "The neighborhood of " + restaurant.name + " restaurant is " + restaurant.neighborhood);
